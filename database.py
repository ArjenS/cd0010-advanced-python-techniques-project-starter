...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        for approach in self._approaches:
            ...
            if neo_designation in self._neos:
                self._neos[neo_designation].approaches.append(approach)
                approach.neo = self._neos[neo_designation]
